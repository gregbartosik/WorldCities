...
using WorldCitiesApi1.Data;
using WorldCitiesApi1.Data.Models;

namespace WorldCitiesApi1.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<ActionResult> Import()
        {
            ...
            var path = Path.Combine(_environment.ContentRootPath, "Data/Source/worldcities1.xlsx");
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                var countryName = row[nRow, 5].GetValue<string>();
                // retrieve coutry Id by countryName
